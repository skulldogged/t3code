...
T3 Code Mobile includes the T3 Code, T3 Chat, Grove, Ocean, Ember, Iris, and Catppuccin Mocha
themes. T3 Code, T3 Chat, Grove, Ocean, Ember, and Iris include light and dark colors. Catppuccin
Mocha is available for dark appearance. Theme colors apply throughout the app, including code
reviews, file previews, the terminal, native headers, and sheets.
